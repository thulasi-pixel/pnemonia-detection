    ...
    ##    MODEL_NAME='keras_model.h5'
        ...
        for num, data in enumerate(verify_data):
            ...
            if np.argmax(model_out) == 0:
                str_label = "Bacterial_pneumonia_stage1"
                print("The predicted image of the Bacterial_pneumonia_stage1 is with a accuracy of {} %".format(model_out[0]*100))
                accuracy="The predicted image of the Bacterial_pneumonia_stage1 is with a accuracy of {}%".format(model_out[0]*100)
                Tre = "The Treatment for Bacterial_pneumonia_stage1 are:\n\n "
                Tre1 = [" Cryotherapy",  
                "Curettage and Electrosurgery"]
                
            elif np.argmax(model_out) == 1:
                str_label  = "Bacterial_pneumonia_stage2"
                print("The predicted image of the Bacterial_pneumonia_stage2 is with a accuracy of {} %".format(model_out[1]*100))
                accuracy="The predicted image of the Bacterial_pneumonia_stage2 is with a accuracy of {}%".format(model_out[1]*100)
                Tre = "The Treatment for Bacterial_pneumonia_stage2 are:\n\n "
                ...
                str_label = "Viral_pneumonia_stage1"
                print("The predicted image of the Viral_pneumonia_stage1 is with a accuracy of {} %".format(model_out[2]*100))
                accuracy="The predicted image of the Viral_pneumonia_stage1 is with a accuracy of {}%".format(model_out[2]*100)
                Tre = "The Treatment for Viral_pneumonia_stage1 are:\n\n "
                ...
                str_label = "Viral_pneumonia_stage2"
                print("The predicted image of the Viral_pneumonia_stage2 is with a accuracy of {} %".format(model_out[3]*100))
                accuracy="The predicted image of the Viral_pneumonia_stage2 is with a accuracy of {}%".format(model_out[3]*100)
                Tre = "The Treatment for Viral_pneumonia_stage2 are:\n\n "
                Tre1 = [" Immunotherapy",  
                "Targeted therapy",
                'Radiation therapy']
                ...
                str_label = "Covid_19"
                print("The predicted image of the Covid_19 is with a accuracy of {} %".format(model_out[4]*100))
                accuracy="The predicted image of the Covid_19 is with a accuracy of {}%".format(model_out[4]*100)
                Tre = "The Treatment for Covid_19 are:\n\n "
                ...
                str_label = "Fungal_pneumonia"
                print("The predicted image of the Fungal_pneumonia is with a accuracy of {} %".format(model_out[5]*100))
                accuracy="The predicted image of the Fungal_pneumonia is with a  accuracy of {}%".format(model_out[5]*100)
                ...
                str_label = "Normal"
                print("The predicted image of the  Normal with a accuracy of {} %".format(model_out[7]*100))
                accuracy="The predicted image of the Normal is with a accuracy of {}%".format(model_out[7]*100)
